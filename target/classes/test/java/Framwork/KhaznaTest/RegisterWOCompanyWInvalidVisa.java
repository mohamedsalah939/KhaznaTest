...
public class RegisterWOCompanyWInvalidVisa extends Capabilities {
	public static Logger log = LogManager.getLogger(Capabilities.class.getName());

	/*
	 * Register individually with invalid Visa and make sure that it is refusing it
	 */
	@Test(dataProvider = "setData")
	public void RegisterWOCmpnyWInvVisa(String FullName, String IDNumber, String VisaNumber)
		...
		// Choose the bank and write the invalid Visa
	...
	public Object[][] setData() throws IOException {
		...
		Object[][] ObjArray = dataDriven.FormatData("RegisterWOCompanyWInvalidVisa");
		return ObjArray;
	}
